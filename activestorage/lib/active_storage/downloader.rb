...
module ActiveStorage
  class Downloader # :nodoc:
    ...
    private
      ...
      def verify_integrity_of(file, checksum:, checksum_algorithm: :MD5)
        ck_sum = ActiveStorage::Checksum.new(checksum, checksum_algorithm) if checksum

        unless service.file(file) == ck_sum
